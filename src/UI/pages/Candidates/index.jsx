...
const filterOptions = accountabilityFilters('Candidates');
...
const CandidatesList = (props: CandidatesListProps) => {
  ...
  const savedSearch = getFilters('candidates');
  ...
  const getData = useCallback(async () => {
    try {
      ...
      saveFilters('candidates', { filters, params });

      const queryParams = queryString.stringify(params);

      const response = await API.get(`${Endpoints.Candidates}?${queryParams}`);
